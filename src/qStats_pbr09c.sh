...
Rscript cgsMods.R $case/null ~/projects/pb_removal_nets/results/null_mods09c.txt
Rscript cgsNest.R $case/null ~/projects/pb_removal_nets/results/null_nest09c.txt
rm ./cgsMods.R
rm ./cgsNest.R
